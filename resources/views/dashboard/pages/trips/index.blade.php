        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <a href="{{url('/')}}/trip/create" class="btn btn-success btn-block">add new trip</a>
                </div>
            </div>
                        ...
                        @foreach($data as $d)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/trip/{{$d->id}}/edit" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
